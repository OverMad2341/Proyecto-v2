<div class="container">
    ...
    <form action="{{ route('users.update', $user->id) }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" name="cedula" value="{{old("cedula", $user["cedula"])}}">
            @error("cedula")
                <p>{{$message}}</p>
            @enderror
        </div>
...
<div class="mb-3">
            ...
            <input type="text" class="form-control" name="name_02" value="{{old("name_02", $user["name_02"])}}">
            @error("name_02")
                <p>{{$message}}</p>
            @enderror
        </div>
<div class="mb-3">
            ...
            <input type="text" class="form-control" name="surname_01" value="{{old("surname_01", $user["surname_01"])}}">
            @error("surname_01")
                <p>{{$message}}</p>
            @enderror
        </div>
<div class="mb-3">
            ...
            <input type="text" class="form-control" name="surname_02" value="{{old("surname_02", $user["surname_02"])}}">
            @error("surname_02")
                <p>{{$message}}</p>
            @enderror
        </div>
<div class="mb-3">
            ...
            <input type="text" class="form-control" name="birth_date" value="{{old("birth_date", $user["birth_date"])}}">
            @error("birth_date")
                <p>{{$message}}</p>
            @enderror
        </div>
<div class="mb-3">
            ...
            <input type="text" class="form-control" name="birth_place" value="{{old("birth_place", $user["birth_place"])}}">
            @error("birth_place")
                <p>{{$message}}</p>
            @enderror
        </div>
<div class="mb-3">
            ...
            <input type="text" class="form-control" name="sex" value="{{old("sex", $user["sex"])}}">
            @error("sex")
                <p>{{$message}}</p>
            @enderror
        </div>
...
<div class="mb-3">
            ...
            <input type="text" class="form-control" name="birth_country" value="{{old("birth_country", $user["birth_country"])}}">
            @error("birth_country")
                <p>{{$message}}</p>
            @enderror
        </div>
<div class="mb-3">
            ...
            <input type="text" class="form-control" name="current_team_id" value="{{old("current_team_id", $user["current_team_id"])}}">
...
<div class="mb-3">
            ...
            <input type="text" class="form-control" name="profile_photo_path" value="{{old("profile_photo_path", $user["profile_photo_path"])}}">
